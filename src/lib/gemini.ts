...
export async function generateSpriteSheet(
  ...
  const characterContext = description
    ...
    : "";
  const prompt = `${characterContext}Sprite sheet of this character ${action}, 3x3 grid, white background, sequence, frame by frame animation, square aspect ratio. Each frame must show the full body from head to feet. Follow the structure of the attached reference image exactly.`;
