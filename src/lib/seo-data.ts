...
export const STYLES = [
    ...
    { slug: "pixel-art", title: "Pixel Art", description: "Nostalgic 16-bit and 32-bit assets for games and apps.", image: "/demo/style-showcase.webp", aesthetics: ["Strict color palettes (16-bit)", "Crisp aliased edges", "Dithered shading", "Nostalgic arcade aesthetic"], fallbackGallery: ["/demo/style-showcase.webp", "/demo/style-retro.png", "/demo/style-cyber.png", "/demo/character-consistency.webp"] }
];
