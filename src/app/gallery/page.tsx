...
export default async function GalleryPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-dotted">
      <div className="relative overflow-hidden border-b border-border/10 bg-gradient-to-b from-candy-purple/5 via-candy-blue/5 to-transparent">
        <div className="mx-auto max-w-6xl px-6 pt-16 pb-12 text-center">
          <h1 className="font-display text-5xl sm:text-7xl text-foreground mb-4 animate-slide-up">
            Mascot <span className="text-gradient">Gallery.</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-xl mx-auto animate-slide-up stagger-2 leading-relaxed">
            Discover community-powered character design. Filter by style, industry, or search for your favorite mascot.
          </p>
        </div>
        <div className="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-candy-purple/10 blur-3xl opacity-50" />
        <div className="absolute -top-10 -left-20 h-48 w-48 rounded-full bg-candy-green/10 blur-3xl opacity-50" />
      </div>
